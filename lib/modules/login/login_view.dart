...
class LoginView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AppLogo(
      child: Column(
        children: [
          FIDText(baseText: "Seja bem-vindo(a)", preset: FIDText.large),
          FIDText(baseText: "Entre com seu usuário e sua senha", padding: {"bottom": 0.03}, preset: FIDText.medium),
          Column(
          ...
          FIDText(baseText: "Não tem uma conta? ", linkText: "Registre-se", route: Routes.registroPage, preset: FIDText.link),
        ],
      )
    );
  }
